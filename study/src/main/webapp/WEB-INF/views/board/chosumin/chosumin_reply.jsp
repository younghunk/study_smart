...
<body>
    <form name="reply">
        <div class="m-auto d-flex flex-column w-50 h-75 justify-content-center p-2">
            <h2>답글쓰기</h2>
                <input id="fk_seq" name="fk_seq" type="text"  value="${boardVO.fk_seq}" hidden>
                <input id="depthno" name="depthno" type="text"  value="${boardVO.depthno}" hidden>
                <input id="groupno" name="groupno" type="text"  value="${boardVO.fk_seq}" hidden>
                <label for="userid" class="mt-2">아이디</label>
                <input id="userid" name="userid" type="text">
                <label for="subject" class="mt-1">제목</label>
                <input id="subject" name="subject" type="text" value="[RE:${boardVO.seq}]">
